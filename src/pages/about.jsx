        ...
        <div className="dark:md:bg-zinc-600 md:bg-zinc-200 w-screen md:h-[60vh] flex justify-center items-center md:relative md:-top-10">
          ...
          >
            ...
            <p className="dark:text-gray text-zinc-500 mt-8 font-sans font-normal leading-7 text-[1rem] md:px-10">
              ...
              Desenvolvimento de Sistemas e em janeiro de 2023 finalizei o bootcamp
            ...
            <div className="mt-10 flex md:flex-row flex-col justify-center items-center gap-10">
              <div className="flex gap-2">
                ...
                <p className="text-lilac text-sm font-medium">São Paulo - Brasil</p>
              </div>
              <div className="flex gap-2">
                <Mail size={20} color="#C778DD" strokeWidth={1} />
                <p className="text-lilac text-sm font-medium">danyelly_mell@hotmail.com</p>
              </div>
            </div>
          </motion.div>
        </div>
